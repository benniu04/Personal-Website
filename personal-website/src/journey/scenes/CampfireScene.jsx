...
function drawNightSky(ctx, { w, h }) {
  drawStars(ctx, { w, h, seed: 'save-point', count: 70, maxY: 0.55 })
}
...
// Save-point backdrop: dimmed stars over the dusk gradient.
...
// The traveler at rest: monument, SAVE POINT sign, sitting avatar, live fire.
// Rendered in the chapter's content flow so it never collides with text.
export function CampfireEnsemble() {
  return (
    <div className="flex items-end gap-8" aria-hidden="true">
